...
If you choose online installation, we recommend you to turn on [download first](/usage/deploy/first-deployment.md#download-first) option to avoid installation failure caused by network issues.
...
By default, 64-bit Office will be installed. For more information please check [architecture](/usage/deploy/settings/basic.md#architecture) section.
