...
如果您選擇線上安裝，我們建議您開啟[先下載後安裝](/zh-tw/usage/deploy/first-deployment.md#download-first)選項，以避免因網路問題導致 Office 安裝失敗。
...
預設情況下，將安裝 64 位元的 Office。如需更多資訊，請參閱[架構](/zh-tw/usage/deploy/settings/basic.md#architecture)章節。
