...
| [CQU Mirror](https://www.officetool.plus/redirect/download.php?site=cqu) | [<svg xmlns="http://www.w3.org/2000/svg" width="24"  viewBox="0 0 24 24"><title>Download</title><path fill="#0078D4" d="M5,20H19V18H5M19,9H15V3H9V9H5L12,16L19,9Z" /></svg>](https://www.officetool.plus/redirect/download.php?site=cqu&type=runtime&arch=x64) | [<svg xmlns="http://www.w3.org/2000/svg" width="24"  viewBox="0 0 24 24"><title>Download</title><path fill="#0078D4" d="M5,20H19V18H5M19,9H15V3H9V9H5L12,16L19,9Z" /></svg>](https://www.officetool.plus/redirect/download.php?site=cqu&type=runtime&arch=arm64) |
...
::: details Install Office Tool Plus via winget

You can also install Office Tool Plus using winget:
...
- The winget package may not be updated as quickly as the official releases, so it may not always have the latest version of Office Tool Plus.
- The winget package does not include the .NET Runtime files. When created an Office ISO file, Office Tool Plus will prompt users to download and install the .NET Runtime if it's not found. This may cause inconvenience for users who do not have the .NET Runtime installed on their system.
- When downloading Office installation files, you will always be asked to choose a location to save the files.
...
Office Tool Plus is protected by a digital signature. When you run the program, Windows will recognize it as being from a verified publisher. If the signature has been tampered with or is invalid, please stop using the software and re-download Office Tool Plus from the [official site](#download).
